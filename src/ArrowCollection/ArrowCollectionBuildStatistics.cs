...
/// <summary>
/// Statistics collected during the build of an ArrowCollection.
/// Provides insights into data characteristics and encoding decisions.
/// </summary>
public sealed class ArrowCollectionBuildStatistics
{
    /// <summary>
    ...
    {
        Console.WriteLine($"ArrowCollection Build Statistics");
        Console.WriteLine($"================================");
