...
/// <summary>
/// Analyzes the long-term memory footprint of FrozenArrow vs List.
...
public static class MemoryFootprintAnalyzer
{
    ...
    public static void Run()
    {
        ...
        Console.WriteLine("|  Compares retained memory for List<T> vs FrozenArrow                     |");
        Console.WriteLine("+==============================================================================+");
        Console.WriteLine();
    ...
    private static (long listMemory, long arrowMemory) MeasureProcessMemory(int itemCount)
    {
        ...
        // Measure FrozenArrow memory footprint
        ForceFullGC();
        process.Refresh();
        var beforeArrow = process.PrivateMemorySize64;
        
        var FrozenArrow = GenerateItemsEnumerable(itemCount, stringCardinality: 100).ToFrozenArrow();
    ...
    private static void RunCardinalityAnalysis()
    {
        ...
        foreach (var cardinality in cardinalities)
        {
            ...
            var FrozenArrow = GenerateItemsEnumerable(itemCount, stringCardinality: cardinality).ToFrozenArrow();
