...
public static class MemoryFootprintAnalyzer
{
    ...
    private static void RunTheoreticalAnalysis()
    {
        ...
        foreach (var count in itemCounts)
        {
            ...
            Console.WriteLine($"  ? {count,10:N0} ? {listTotalMB,15:F2} ? {arrowTotalMB,15:F2} ? {savingsPercent,10:F1}% ?");
        }
    ...
    private static void RunEmpiricalAnalysis()
    {
        ...
        foreach (var size in sizes)
        {
            ...
            Console.WriteLine($"? {size,10:N0} ? {listManaged / (1024.0 * 1024.0),16:F3} ? {arrowManaged / (1024.0 * 1024.0),16:F3} ? {arrowNativeEstimate / (1024.0 * 1024.0),16:F3} ?");
        }
    ...
    private static void RunCardinalityAnalysis()
    {
        ...
        foreach (var cardinality in cardinalities)
        {
            ...
            Console.WriteLine($"? {cardinality,12:N0} ? {listMB,16:F2} ? {arrowMB,16:F2} ? {savings,14:F1}% ?");
        }
