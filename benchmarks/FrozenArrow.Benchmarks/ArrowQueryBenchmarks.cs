...
/// 2. FrozenArrow with Enumerable LINQ (materializes all items then filters)
/// 3. FrozenArrow with ArrowQuery (column-level filtering, selective materialization)
/// </summary>
[MemoryDiagnoser]
...
public class ArrowQueryBenchmarks
{
    ...
    /// <summary>
    /// FrozenArrow with Enumerable.Where - materializes ALL items then filters.
    /// This is the "wrong" way to query FrozenArrow.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("HighSelectivity")]
    public int FrozenArrow_Enumerable_HighSelectivity_ToList()
    {
        return _FrozenArrow.Where(x => x.Age > 55).ToList().Count;
    }

    /// <summary>
    /// ArrowQuery with column-level filtering - only materializes matching rows.
    /// This is the "right" way to query FrozenArrow.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("HighSelectivity")]
    ...
    [Benchmark]
    [BenchmarkCategory("MediumSelectivity")]
    public int FrozenArrow_Enumerable_MediumSelectivity_ToList()
    {
        return _FrozenArrow.Where(x => x.Age > 40).ToList().Count;
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Age > 40).ToList().Count;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("LowSelectivity")]
    public int FrozenArrow_Enumerable_LowSelectivity_ToList()
    {
        return _FrozenArrow.Where(x => x.Age > 20).ToList().Count;
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Age > 20).ToList().Count;
    }
    ...
    /// <summary>
    /// Count with FrozenArrow Enumerable - materializes all items, then counts.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("Count")]
    public int FrozenArrow_Enumerable_Count()
    {
        return _FrozenArrow.Where(x => x.Age > 40).Count();
    }
    ...
    /// <summary>
    /// Any with FrozenArrow Enumerable - materializes until first match.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("Any")]
    public bool FrozenArrow_Enumerable_Any()
    {
        return _FrozenArrow.Where(x => x.Category == "Executive").Any();
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Category == "Executive").Any();
    }
    ...
    /// <summary>
    /// First with FrozenArrow Enumerable - materializes until first match.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("First")]
    public string FrozenArrow_Enumerable_First()
    {
        return _FrozenArrow.Where(x => x.Age > 50).First().Name;
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Age > 50).First().Name;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("MultiPredicate")]
    public int FrozenArrow_Enumerable_MultiPredicate_ToList()
    {
        return _FrozenArrow
            .Where(x => x.Age > 30 && x.IsActive && x.Category == "Engineering")
            .ToList().Count;
    ...
    [Benchmark]
    [BenchmarkCategory("StringContains")]
    public int FrozenArrow_Enumerable_StringContains_ToList()
    {
        return _FrozenArrow.Where(x => x.Name.Contains("42")).ToList().Count;
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Name.Contains("42")).ToList().Count;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("StringEquality")]
    public int FrozenArrow_Enumerable_StringEquality_ToList()
    {
        return _FrozenArrow.Where(x => x.Category == "Engineering").ToList().Count;
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Category == "Engineering").ToList().Count;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("DecimalComparison")]
    public int FrozenArrow_Enumerable_DecimalComparison_ToList()
    {
        return _FrozenArrow.Where(x => x.Salary > 75000m).ToList().Count;
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Salary > 75000m).ToList().Count;
    }
    ...
    /// <summary>
    /// Sum with FrozenArrow Enumerable - materializes all items, then sums.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("Sum")]
    public decimal FrozenArrow_Enumerable_Sum()
    {
        return _FrozenArrow.Where(x => x.IsActive).Sum(x => x.Salary);
    }
    ...
    /// <summary>
    /// Average with FrozenArrow Enumerable.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("Average")]
    public double FrozenArrow_Enumerable_Average()
    {
        return _FrozenArrow.Where(x => x.IsActive).Average(x => x.Age);
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.IsActive).Average(x => x.Age);
    }
    ...
    /// <summary>
    /// Min with FrozenArrow Enumerable.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("Min")]
    public decimal FrozenArrow_Enumerable_Min()
    {
        return _FrozenArrow.Where(x => x.Category == "Engineering").Min(x => x.Salary);
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Category == "Engineering").Min(x => x.Salary);
    }
    ...
    /// <summary>
    /// Max with FrozenArrow Enumerable.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("Max")]
    public decimal FrozenArrow_Enumerable_Max()
    {
        return _FrozenArrow.Where(x => x.Category == "Engineering").Max(x => x.Salary);
    }
    ...
    {
        return _FrozenArrow.AsQueryable().Where(x => x.Category == "Engineering").Max(x => x.Salary);
    }
