...
public class FrozenArrowBenchmarks
{
    ...
    private FrozenArrow<BenchmarkItem> _collection10K = null!;
    private FrozenArrow<BenchmarkItem> _collection100K = null!;
    private FrozenArrow<BenchmarkItem> _collection1M = null!;
    ...
    public void Setup()
    {
        ...
        _collection10K = _items10K.ToFrozenArrow();
        _collection100K = _items100K.ToFrozenArrow();
        _collection1M = _items1M.ToFrozenArrow();
    }
    ...
    [Benchmark]
    [BenchmarkCategory("Construction", "10K")]
    public FrozenArrow<BenchmarkItem> Colly_Construction_10K()
    {
        var collection = _items10K.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("Construction", "100K")]
    public FrozenArrow<BenchmarkItem> Colly_Construction_100K()
    {
        var collection = _items100K.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("Construction", "1M")]
    public FrozenArrow<BenchmarkItem> Colly_Construction_1M()
    {
        var collection = _items1M.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
...
/// <summary>
/// Benchmarks comparing class vs struct performance in FrozenArrow.
/// </summary>
[MemoryDiagnoser]
[Orderer(SummaryOrderPolicy.FastestToSlowest)]
public class StructVsClassBenchmarks
{
    ...
    private FrozenArrow<BenchmarkItem> _classCollection = null!;
    private FrozenArrow<BenchmarkStruct> _structCollection = null!;
    private FrozenArrow<BenchmarkReadonlyStruct> _readonlyStructCollection = null!;
    ...
    public void Setup()
    {
        ...
        _classCollection = _classItems.ToFrozenArrow();
        _structCollection = _structItems.ToFrozenArrow();
        _readonlyStructCollection = _readonlyStructItems.ToFrozenArrow();
    ...
    public FrozenArrow<BenchmarkItem> Class_Construction()
    {
        var collection = _classItems.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("Construction")]
    public FrozenArrow<BenchmarkStruct> Struct_Construction()
    {
        var collection = _structItems.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
    ...
    [Benchmark]
    [BenchmarkCategory("Construction")]
    public FrozenArrow<BenchmarkReadonlyStruct> ReadonlyStruct_Construction()
    {
        var collection = _readonlyStructItems.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
