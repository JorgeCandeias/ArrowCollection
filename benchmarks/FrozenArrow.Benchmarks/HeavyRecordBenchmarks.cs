...
/// This tests FrozenArrow's performance with wide tables containing:
...
public class HeavyRecordBenchmarks
{
    ...
    private FrozenArrow<HeavyBenchmarkItem> _collection = null!;
    ...
    public void Setup()
    {
        ...
        Console.WriteLine("Building FrozenArrow<T> for enumeration benchmarks...");
        _collection = _sourceItems.ToFrozenArrow();
    ...
    [Benchmark]
    [BenchmarkCategory("Heavy", "Construction")]
    public FrozenArrow<HeavyBenchmarkItem> Arrow_Construction_Heavy_1M()
    {
        var collection = _sourceItems.ToFrozenArrow();
        collection.Dispose();
        return collection;
    }
