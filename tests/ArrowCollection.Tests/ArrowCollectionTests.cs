...
/// </summary>
public class ArrowCollectionStructTests
{
    #region Test Structs
    ...
    [Fact]
    public void ToArrowCollection_WithSimpleStruct_CanEnumerateAll()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithReadonlyStruct_CanEnumerateAll()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithComplexStruct_PreservesAllDataTypes()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithNullableStruct_HandlesNullsCorrectly()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithReadonlyNullableStruct_HandlesNullsCorrectly()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithEmptyStructCollection_ReturnsEmpty()
    {
        // Arrange
    ...
    [Fact]
    public void ToArrowCollection_WithEmptyReadonlyStructCollection_ReturnsEmpty()
    {
        // Arrange
    ...
    [Fact]
    public void ToArrowCollection_WithStruct_CanEnumerateMultipleTimes()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithReadonlyStruct_CanEnumerateMultipleTimes()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithFieldStruct_CanEnumerateAll()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithLargeStructDataset_HandlesCorrectly()
    {
        // Arrange
    ...
    [Fact]
    public void ToArrowCollection_WithLargeReadonlyStructDataset_HandlesCorrectly()
    {
        // Arrange
    ...
    [Fact]
    public void ToArrowCollection_StructIsImmutable_OriginalDataChangesDoNotAffect()
    {
        // Arrange
    ...
    [Fact]
    public void ToArrowCollection_WithDefaultStruct_HandlesDefaults()
    {
...
/// </summary>
public class ArrowCollectionStructEdgeCaseTests
{
    /// <summary>
    ...
    [Fact]
    public void ToArrowCollection_WithAllNumericTypes_PreservesValues()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithSingleFieldStruct_Works()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithSingleFieldReadonlyStruct_Works()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToArrowCollection_WithLinqQueryOnStruct_Works()
    {
        // Arrange
    ...
    [Fact]
    public void ToArrowCollection_WithStructContainingBooleans_PreservesBoolValues()
    {
