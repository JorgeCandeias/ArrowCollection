...
/// <summary>
/// Tests for FrozenArrow serialization and deserialization functionality.
/// </summary>
public class SerializationTests
{
    ...
    public void RoundTrip_WithSimpleRecord_PreservesData()
    {
        ...
        using var original = items.ToFrozenArrow();
        ...
        // Act - Deserialize
        using var deserialized = FrozenArrow<SimpleRecord>.ReadFrom(buffer.WrittenSpan);
    ...
    public async Task RoundTripAsync_WithStream_PreservesData()
    {
        ...
        // Act - Deserialize
        using var deserialized = await FrozenArrow<SimpleRecord>.ReadFromAsync(stream);
    ...
    public void RoundTrip_WithReadOnlySequence_PreservesData()
    {
        ...
        // Act - Deserialize
        using var deserialized = FrozenArrow<SimpleRecord>.ReadFrom(sequence);
    ...
    public void RoundTrip_WithNullableValues_PreservesNulls()
    {
        ...
        var buffer = new ArrayBufferWriter<byte>();
        original.WriteTo(buffer);
        using var deserialized = FrozenArrow<RecordWithNullables>.ReadFrom(buffer.WrittenSpan);
    ...
    public void RoundTrip_WithStruct_PreservesData()
    {
        ...
        var buffer = new ArrayBufferWriter<byte>();
            original.WriteTo(buffer);
            using var deserialized = FrozenArrow<SerializationStruct>.ReadFrom(buffer.WrittenSpan);
        ...
        public void RoundTrip_WithPositionalRecordClass_PreservesData()
        {
            ...
            var buffer = new ArrayBufferWriter<byte>();
            original.WriteTo(buffer);
            using var deserialized = FrozenArrow<PositionalRecord>.ReadFrom(buffer.WrittenSpan);
        ...
        public void RoundTrip_WithPositionalRecordClassAndExplicitNames_PreservesData()
        {
            ...
            var buffer = new ArrayBufferWriter<byte>();
            original.WriteTo(buffer);
            using var deserialized = FrozenArrow<PositionalRecordWithNames>.ReadFrom(buffer.WrittenSpan);
        ...
        public void RoundTrip_WithPositionalRecordStruct_PreservesData()
        {
            ...
            var buffer = new ArrayBufferWriter<byte>();
            original.WriteTo(buffer);
            using var deserialized = FrozenArrow<PositionalRecordStruct>.ReadFrom(buffer.WrittenSpan);
        ...
        public void RoundTrip_WithReadonlyPositionalRecordStruct_PreservesData()
        {
            ...
            var buffer = new ArrayBufferWriter<byte>();
            original.WriteTo(buffer);
            using var deserialized = FrozenArrow<ReadonlyPositionalRecordStruct>.ReadFrom(buffer.WrittenSpan);
        ...
        public async Task RoundTripAsync_WithPositionalRecordClass_PreservesData()
        {
            ...
            await original.WriteToAsync(stream);
            stream.Position = 0;
            using var deserialized = await FrozenArrow<PositionalRecord>.ReadFromAsync(stream);
        ...
        public async Task RoundTripAsync_WithPositionalRecordStruct_PreservesData()
        {
            ...
            await original.WriteToAsync(stream);
            stream.Position = 0;
            using var deserialized = await FrozenArrow<PositionalRecordStruct>.ReadFromAsync(stream);
    ...
    public void ReadFrom_WithDefaultOptions_IgnoresUnknownColumns()
    {
        ...
        using var deserialized = FrozenArrow<SimpleRecord>.ReadFrom(
            buffer.WrittenSpan, 
    ...
    public void ReadFrom_WithDefaultOptions_UseDefaultForMissingColumns()
    {
        ...
        using var deserialized = FrozenArrow<SimpleRecord>.ReadFrom(buffer.WrittenSpan, options);
        Assert.Equal(1, deserialized.Count);
    }
    ...
    public void RoundTrip_WithExplicitNames_PreservesData()
    {
        ...
        var buffer = new ArrayBufferWriter<byte>();
        original.WriteTo(buffer);
        using var deserialized = FrozenArrow<RecordWithExplicitNames>.ReadFrom(buffer.WrittenSpan);
    ...
    public async Task ReadFromAsync_WithNullStream_ThrowsArgumentNullException()
    {
        await Assert.ThrowsAsync<ArgumentNullException>(() => 
            FrozenArrow<SimpleRecord>.ReadFromAsync(null!));
    }
    ...
    public void ReadFrom_WithEmptyData_ThrowsInvalidOperationException()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => 
            FrozenArrow<SimpleRecord>.ReadFrom(emptyArray.AsSpan()));
    }
    ...
    public async Task ReadFromAsync_WithCancellation_CanBeCancelled()
    {
        ...
        try
        {
            await FrozenArrow<SimpleRecord>.ReadFromAsync(stream, cancellationToken: cts.Token);
        }
        catch (OperationCanceledException)
        {
            // Expected if cancellation was checked
