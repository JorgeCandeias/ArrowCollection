...
public class PositionalRecordTests
{
    ...
    [Fact]
    public void ToFrozenArrow_WithPositionalRecord_Works()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToFrozenArrow_WithPositionalRecordAndExplicitNames_Works()
    {
        // Arrange
    ...
    [Fact]
    public void ToFrozenArrow_WithPositionalRecordAndNullables_PreservesNulls()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToFrozenArrow_WithMixedPositionalAndAdditionalProperties_Works()
    {
        // Arrange
    ...
    [Fact]
    public void ToFrozenArrow_WithPositionalRecordStruct_Works()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToFrozenArrow_WithReadonlyRecordStruct_Works()
    {
        // Arrange
        var items = new[]
        {
    ...
    [Fact]
    public void ToFrozenArrow_WithNamedRecordStruct_Works()
    {
        // Arrange
        var items = new[]
        {
    ...
    public void RoundTrip_WithPositionalRecord_PreservesData()
    {
        ...
        // Act - Deserialize
        using var deserialized = FrozenArrow<PersonRecord>.ReadFrom(buffer.WrittenSpan);
    ...
    public void RoundTrip_WithPositionalRecordStruct_PreservesData()
    {
        ...
        var buffer = new ArrayBufferWriter<byte>();
        original.WriteTo(buffer);
        using var deserialized = FrozenArrow<PointRecord>.ReadFrom(buffer.WrittenSpan);
    ...
    public void RoundTrip_WithReadonlyRecordStruct_PreservesData()
    {
        ...
        var buffer = new ArrayBufferWriter<byte>();
        original.WriteTo(buffer);
        using var deserialized = FrozenArrow<ReadonlyPointRecord>.ReadFrom(buffer.WrittenSpan);
    ...
    public async Task RoundTripAsync_WithPositionalRecord_PreservesData()
    {
        ...
        stream.Position = 0;
        using var deserialized = await FrozenArrow<PersonRecord>.ReadFromAsync(stream);
    ...
    [Fact]
    public void ToFrozenArrow_WithLargePositionalRecordDataset_Works()
    {
        // Arrange
    ...
    [Fact]
    public void ToFrozenArrow_WithLargeRecordStructDataset_Works()
    {
        // Arrange
        var items = Enumerable.Range(1, 10000)
