...
Console.WriteLine("FrozenArrow - Frozen Collection Demo\n");
Console.WriteLine("================================\n");
...
using (var collection = weatherData.ToFrozenArrow())
{
...
using (var collection = data3.ToFrozenArrow())
{
    // First enumeration
...
using (var structCollection = sensorReadings.ToFrozenArrow())
{
...
using (var readonlyCollection = immutableReadings.ToFrozenArrow())
{
...
using (var sciCollection = scientificData.ToFrozenArrow())
{
